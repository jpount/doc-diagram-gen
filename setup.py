...
"""
    ...
    def ensure_repomix_config(self):
        ...
        if not repomix_config_file.exists():
            repomix_config = {
                "output": {
                    "filePath": "output/reports/repomix-summary.md",
                    "style": "markdown",
                    "headerText": f"# {self.project_name} Codebase Summary\\nGenerated by Repomix for AI-optimized analysis",
                    "removeComments": False,
                    "removeEmptyLines": False,
                    "showLineNumbers": True,
                    "copyToClipboard": False
                },
                "include": ["**/*.java", "**/*.js", "**/*.ts", "**/*.py", "**/*.cs", "**/*.html", "**/*.css", "**/*.xml"],
                "ignore": {
                    "useGitignore": True,
                    "useDefaultPatterns": True,
                    "customPatterns": ["node_modules/**", "target/**", "build/**", "dist/**"]
                }
            }
