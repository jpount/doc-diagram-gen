...
**NO JSON summary dependencies** - analyze UI patterns directly from source code.
...
- **NO hardcoded UI components or fabricated patterns** - analyze ONLY actual UI code
- **NO predetermined component hierarchies** - map only detected structures
- **NO example UI solutions** - focus on detected UI patterns
