...
- Cross-reference with solution architect findings where available
...
- 🔴 **Critical**: Blocking technical issues, critical design flaws
- 🟠 **High**: Significant technical debt, major design concerns
- 🟡 **Medium**: Notable technical considerations, moderate issues
- ⚠️ **Warning**: Potential technical problems, code smells
- ✅ **Good**: Well-implemented technical patterns, good practices
- 🚨 **Security**: Technical security vulnerabilities, unsafe practices
- ⚡ **Performance**: Performance-impacting technical decisions
- 🏗️ **Technical Debt**: Maintenance issues, refactoring needs
...
if Path("output/context/solution-architect-summary.json").exists():
    solution_architect_context = Read("output/context/solution-architect-summary.json")
    print("✅ Solution architect context loaded")
