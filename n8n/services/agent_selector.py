...
class AgentSelector:
    ...
    def get_final_agent_list(self) -> List[str]:
        ...
        # Ensure solution-architect is first after repomix-analyzer
        if "solution-architect" not in agents and "repomix-analyzer" in agents:
            agents.insert(1, "solution-architect")
