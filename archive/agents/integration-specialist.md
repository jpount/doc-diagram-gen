...
2. `output/docs/integration-analysis.md` - Main integration documentation
...
```bash
python3 framework/scripts/simple_mermaid_validator.py output/docs/integration-analysis.md
...
Write("output/docs/integration-analysis.md", integration_documentation)
