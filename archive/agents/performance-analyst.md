...
2. `output/docs/performance-analysis.md` - Main performance documentation
...
```bash
python3 framework/scripts/simple_mermaid_validator.py output/docs/performance-analysis.md
...
Write("output/docs/performance-analysis.md", performance_documentation)
